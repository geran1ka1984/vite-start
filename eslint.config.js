...
export default [
  { ignores: ["node_modules", "dist"] },
  {
    ...
    rules: {
      ...
      eqeqeq: ["error", "always"], // Это правило направлено на устранение небезопасных с точки зрения типов операторов равенства.
      strict: ["error", "global"], // Требовать или запрещать директивы строгого режима
      "max-nested-callbacks": [
        // обеспечивает максимальную глубину вложенности обратных вызовов
